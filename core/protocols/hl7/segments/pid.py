...
class PID(HL7Segment):
    ...
    patient_id: Optional[Any] = Field(default=None)
    patient_identifier_list: Optional[Any] = Field(default=None)
    alternate_patient_id: Optional[Any] = Field(default=None)
    patient_name: Optional[Any] = Field(default=None)
    mothers_maiden_name: Optional[Any] = Field(default=None)
    date_time_of_birth: Optional[Any] = Field(default=None)
    administrative_sex: Optional[Any] = Field(default=None)
    patient_alias: Optional[Any] = Field(default=None)
    race: Optional[Any] = Field(default=None)
    patient_address: Optional[Any] = Field(default=None)
    county_code: Optional[Any] = Field(default=None)
    phone_number_home: Optional[Any] = Field(default=None)
    phone_number_business: Optional[Any] = Field(default=None)
    primary_language: Optional[Any] = Field(default=None)
    marital_status: Optional[Any] = Field(default=None)
    religion: Optional[Any] = Field(default=None)
    patient_account_number: Optional[Any] = Field(default=None)
    ssn_number: Optional[Any] = Field(default=None)
    drivers_license_number: Optional[Any] = Field(default=None)
    mothers_identifier: Optional[Any] = Field(default=None)
    ethnic_group: Optional[Any] = Field(default=None)
    birth_place: Optional[Any] = Field(default=None)
    multiple_birth_indicator: Optional[Any] = Field(default=None)
    birth_order: Optional[Any] = Field(default=None)
    citizenship: Optional[Any] = Field(default=None)
    veterans_military_status: Optional[Any] = Field(default=None)
    nationality: Optional[Any] = Field(default=None)
    patient_death_date_time: Optional[Any] = Field(default=None)
    patient_death_indicator: Optional[Any] = Field(default=None)