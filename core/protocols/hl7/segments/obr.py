...
class OBR(HL7Segment):
    ...
    set_id: Optional[Any] = Field(default=None)
    placer_order_number: Optional[Any] = Field(default=None)
    filler_order_number: Optional[Any] = Field(default=None)
    universal_service_identifier: Optional[Any] = Field(default=None)
    priority: Optional[Any] = Field(default=None)
    requested_date_time: Optional[Any] = Field(default=None)
    observation_date_time: Optional[Any] = Field(default=None)
    observation_end_date_time: Optional[Any] = Field(default=None)
    collection_volume: Optional[Any] = Field(default=None)
    collector_identifier: Optional[Any] = Field(default=None)
    specimen_action_code: Optional[Any] = Field(default=None)
    danger_code: Optional[Any] = Field(default=None)
    relevant_clinical_information: Optional[Any] = Field(default=None)
    specimen_received_date_time: Optional[Any] = Field(default=None)
    specimen_source: Optional[Any] = Field(default=None)
    ordering_provider: Optional[Any] = Field(default=None)
    order_callback_phone_number: Optional[Any] = Field(default=None)
    placer_field_1: Optional[Any] = Field(default=None)
    placer_field_2: Optional[Any] = Field(default=None)
    filler_field_1: Optional[Any] = Field(default=None)
    filler_field_2: Optional[Any] = Field(default=None)
    results_report_status_change_date_time: Optional[Any] = Field(default=None)
    charge_to_practice: Optional[Any] = Field(default=None)
    diagnostic_service_section_id: Optional[Any] = Field(default=None)
    result_status: Optional[Any] = Field(default=None)
    parent_result: Optional[Any] = Field(default=None)
    quantity_timing: Optional[Any] = Field(default=None)
    result_copies_to: Optional[Any] = Field(default=None)
    parent: Optional[Any] = Field(default=None)
    transportation_mode: Optional[Any] = Field(default=None)
    reason_for_study: Optional[Any] = Field(default=None)
    principal_result_interpreter: Optional[Any] = Field(default=None)
    assistant_result_interpreter: Optional[Any] = Field(default=None)
    technician: Optional[Any] = Field(default=None)
    transcriptionist: Optional[Any] = Field(default=None)
    scheduled_date_time: Optional[Any] = Field(default=None)
    number_of_sample_containers: Optional[Any] = Field(default=None)
    transport_logistics_of_collected_sample: Optional[Any] = Field(default=None)
    collectors_comment: Optional[Any] = Field(default=None)
    transport_arrangement_responsibility: Optional[Any] = Field(default=None)
    transport_arranged: Optional[Any] = Field(default=None)
    escort_required: Optional[Any] = Field(default=None)
    planned_patient_transport_comment: Optional[Any] = Field(default=None)